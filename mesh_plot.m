function mesh_plot(numbering, lvec, seg_dia_repeated, l_segments, dist_segments, d_segments, num_discs, l_discs, d_discs, dist_discs, num_bearings, dist_bearings)
